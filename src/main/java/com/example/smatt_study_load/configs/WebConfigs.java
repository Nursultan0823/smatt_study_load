    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/umm/methodical", "/umm/methodical/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/umm/methodical/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/umm/methodical/**").hasRole("ADMIN")
